...
这个半开玩笑的帖子迅速在 Tumblr 上演变为一个完整的视觉美学运动。
...
- 融合 House、Trance、Chillwave
- 大量使用水声采样（气泡、海浪、声纳）
- 代表艺术家：Ultrademon、Zombelle、Coral Records
...
尽管 Seapunk 作为独立运动只存活了约两年，但它的影响深远：
- 证明了互联网可以独立产生美学运动
- 建立了"Tumblr 美学"的运作模式（后来的 Cottagecore、Dark Academia 等都遵循类似路径）
- 虹彩/全息材质从此成为主流时尚元素
- 为 Vaporwave 的视觉语言提供了基础
...
- 本项目相关：[Vaporwave](vaporwave.md) | [Cyber Y2K](cyber-y2k.md) | [Webcore](webcore.md)
